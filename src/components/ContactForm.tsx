        ...
        <div className="flex flex-row justify-center items-center h-full gap-2 h-max-[20rem] py-6">
            <section className="flex flex-col justify-center items-center">
                <form className="flex flex-col gap-4 w-[30rem]">
                    ...
                    <textarea
                        placeholder="Message"
                        className="w-full resize row-span-5 rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                    />
